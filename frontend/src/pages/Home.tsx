    ...
    <>
      ...
      <div className="content">
        ...
        <div className="right-element absolute right-0 w-2/5 h-[calc(100vh-60px)] overflow-hidden bg-spotifyBlack flex flex-col items-center justify-center pr-10">
          ...
          <p className="mx-12 my-3 text-center text-spotifyWhite">
          ...
          <Button
            onClick={HandleLogin}
            className="max-w-sm bg-spotifyWhite text-spotifyBlack text-lg font-bold py-2 px-8 rounded-xl hover:bg-slate-200"
          >
